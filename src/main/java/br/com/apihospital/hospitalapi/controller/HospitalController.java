...
public class HospitalController {
    ...
    public ResponseEntity ListarPorCnpj(@PathVariable Integer cnpj) {
        try {
    ...
    public ResponseEntity atualizarHospital(@PathVariable Integer cnpj , @RequestBody Hospital hospital) {
        try {
    ...
    public ResponseEntity deletarHospital(@PathVariable Integer cnpj) {
        try {
